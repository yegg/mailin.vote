...
my $state_apply_online = $state_data{$state}{'apply_online'};
{
	...
	$state_apply_online = qq(Yes, <a href="$state_apply_online">here's the site</a>);
...
<div class="answer">Yes, <a href="$state_form_url">here's the form</a>.</div>
EOH
    ;
}
...
if ($state_info_url) {
    print <<EOH
<div class="question">Where can I get more info?</div>
<div class="answer"><a href="$state_info_url">Here's the government site</a>.</div>
EOH
	;
}
